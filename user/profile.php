...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="site-section site-section-sm">
      <div class="container">
      <div class="col-md-7 text-center"><h1 class="md-4">Contact Us</h1></div> 
        <div class="row">
          <div class="col-md-12 col-lg-8 mb-5">
            ...
            <form action="" class="p-5 bg-white" method="POST">
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="text" id="phone" name="tlp" class="form-control" placeholder="No Tlp.">
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <textarea name="message" id="message" name="isi" cols="30" rows="5" class="form-control" placeholder="Hubunggi Kami"></textarea>
                </div>
              </div>

              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" value="Send Message" name="mail" class="btn btn-primary pill px-4 py-2">
                </div>
              </div>
